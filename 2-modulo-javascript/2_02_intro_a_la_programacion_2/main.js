...
<li class="js-listItem"><img src="${secondDogImage}" class="dog" width="200px"> ${secondDogName}</li>
<li class="js-listItem"><img src="${thirdDogImage}" class="dog" width="200px"> ${thirdDogName}</li>`;
