  ...
  renderSeriesList() {
    ...
    return this.state.series
      ...
      .map((serie) => {
        return (
          <Link to="/showdetail">
            <li key={serie.show.id}>Nombre: {serie.show.name}</li>
          </Link>
        );
      });
  }
  ...
  render() {
    return (
      <div>
        ...
        <p>
          Explicación: estamos llamando al API por la serie "friends" ya que
          esta devuelve series en English, Japanese, Korean... y así sí podemos
          filtrar por idioma.
        </p>
        ...
        <input
          type="text"
          onChange={this.handleFilterLanguage}
